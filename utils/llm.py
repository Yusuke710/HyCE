...
from .config import AVAILABLE_MODELS, MAX_NUM_TOKENS, DEFAULT_MODEL, AVAILABLE_LLMS, SYSTEM_CONFIG
...
def get_response_from_llm(
    ...
    # Get system settings
    temperature = temperature or SYSTEM_CONFIG.get('temperature', 0.7)
    max_tokens = SYSTEM_CONFIG.get('max_tokens', 4096)
